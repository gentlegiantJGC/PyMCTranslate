...
def raw_text_to_section_string(raw_text: str) -> str:
    ...
    for section in raw_text_obj:
        ...
        if ('color' not in section and colour) or ('color' in section and section['color'] not in colour_to_code_map) or \
        ...
        if 'color' in section and section['color'] in colour_to_code_map and section['color'] != colour:
